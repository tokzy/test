...
<!--(BIGGER CONTAINER) -->
<div class="container cv2-left l-float">
<!-- user name -->
<div class="user-name">
<h1 class="bold">JOHN DOE</h1>
</div>
<!-- OBJECTIVE -->
<div class="gi">
<div class="info-header">
<h2 class="cv2-h2">Objective</h2>
</div>
<div class="info-text">
...
<!-- SMALLER CONTAINER -->
<div class=" container cv2-right r-float">
<!-- user image -->
<div class="user-img">
<img src="./img/images.jpg" alt="cv-img">
</div>
<!-- other personal info -->
<div class="opi">
<div class="opi-item ">
<p class="opi-item-title"><img src="./img/android.png"></p>
<p>000-000-000-000</p>
</div>

<div class="opi-item ">
<p class="opi-item-title"><img src="./img/secured-letter-w.png"></p>
<p>johndoe@gmail.com</p>
</div>

<div class="opi-item ">
<p class="opi-item-title"><img src="./img/user-location-w.png"></p>
<p>Block number, Street Name, City, State, Country, Zip code</p>
</div>

<div class="opi-item ">
<p class="opi-item-title"><img src="./img/globe.png"></p>
<p>www.johndoe.com</p>
</div>
...
<div class="opi-item ">
<p class="opi-item-title extra-info">Marital Status:</p>
<p>Confused</p>
</div>
</div>
